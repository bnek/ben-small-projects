...
All tasks write to: `docs/project-docs.md`
- Task 1 (Project Overview) **creates** the file with the header and Section 1
- Tasks 2–6 **append** their section to the existing file
